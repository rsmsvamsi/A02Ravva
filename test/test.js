...
QUnit.test('Testing Multiplication function with four sets of inputs', function (assert) {
    ...
    assert.strictEqual(multiply(1,2), 2, 'All positive numbers');
    assert.strictEqual(multiply(1,-2), -2, 'Positive and negative numbers');
    assert.strictEqual(multiply(-1,-2), 2, 'All are negative numbers');
});
QUnit.test('Testing Addition function with four sets of inputs', function (assert) {
    ...
    assert.strictEqual(sum(1,2), 3, 'All positive numbers');
    assert.strictEqual(sum(1,-2), -1, 'Positive and negative numbers');
    assert.strictEqual(sum(-1,-2), -3, 'All are negative numbers');
});
